        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if args.save_n_steps >= 200:
               if global_step < args.max_train_steps-100 and global_step+1==i:
                  ...
                  inst=save_dir[16:]
                  inst=inst.replace(" ", "_")
                  print(" [1;32mSAVING CHECKPOINT: /outputs/"+inst+".ckpt")
                  ...
                  if accelerator.is_main_process:
                     ...
                     chkpth="/outputs/"+inst+".ckpt"
                     subprocess.call('python convert_diffusers_to_original_stable_diffusion.py --model_path ' + save_dir + ' --checkpoint_path ' + chkpth + ' --half', shell=True)
